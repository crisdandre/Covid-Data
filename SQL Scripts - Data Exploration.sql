...
--Looking at Total cases vs Population to check the percentage of infected individuals over time around the world, and in Spain
...
Where continent IS NOT NULL and location <> 'European Union'
Order by location, date
--Adding Vaccination Rate column
...
--Looking at Countries with Highest Vaccination Rate using TEMP table #PeopleVaccinations
